...
-- [[ Setting options ]]
require 'kickstart.plugins.vim-options'
...
require('lazy').setup({
        ...
        defaults = {
          colors = {
            normal = {
              ...
              normal_inactive = { fg = '#333333', bg = '#ffffff' },
              normal_visible = { fg = '#333333', bg = '#ffffff' },
              search = { fg = '#000000', bg = '#ffffff' },
              selection = { fg = '#333333', bg = '#ffffff' },
              visible = { fg = '#333333', bg = '#ffffff' },
              visible_inactive = { fg = '#333333', bg = '#ffffff' },
              visible_visible = { fg = '#333333', bg = '#ffffff' },
            },
          },
        },
      }
  ...
  -- Uncomment this if you have custom plugins
